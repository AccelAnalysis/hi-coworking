...
export function renderEmailSubject(jobType: string, ctx: CampaignContext): string {
...
export function renderEmailHtml(jobType: string, ctx: CampaignContext): string {
...
export function renderSmsBody(jobType: string, ctx: CampaignContext): string {
...
export function renderPushTitle(jobType: string, ctx: CampaignContext): string {
  return renderEmailSubject(jobType, ctx);
}

export function renderPushBody(jobType: string, ctx: CampaignContext): string {
  const title = ctx.eventTitle || "our event";
  switch (jobType) {
    case "announce":
